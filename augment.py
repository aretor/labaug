...
def main2():
    ...
    path_fun = lambda method, net_name, tr_perc, exp: osp.join(label_dir,
                                                               method,
                                                               net_name,
                                                               'labels_' +
                                                               str(tr_perc) +
    ...
    for exp in range(cfg.NUM_EXPS):
        ...
        for net_model in net_models:
            ...
            for tr_perc in tr_percs:
                ...
                labeled, unlabeled = augment_tools.equiclass_mapping(labels, tr_perc)
                ps = augment_tools.init_rand_probability(labels, labeled, unlabeled)
                ...
                augment_tools.create_relabeled_file(fnames, gtg_path, gtg_labels, sep=',')
                ...
                augment_tools.create_relabeled_file(fnames, svm_path, gtg_labels, sep=',')
                ...
                augment_tools.create_relabeled_file(labeled_only,
                                                    labeled_only_path,
                                                    gtg_labels[labeled.astype(int)],
                                                    sep=',')
